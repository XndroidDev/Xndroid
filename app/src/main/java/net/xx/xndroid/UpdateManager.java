...
class DownloadReceiver extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent) {
        if(intent.getAction().equals(DownloadManager.ACTION_DOWNLOAD_COMPLETE)){
            ...
            {
                LogUtil.defaultLogWrite("info", "download apk finished, start to install");
                ...
                if(version > AppModel.sVersionCode){
                    ...
                    builder.setPositiveButton(R.string.update, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            LogUtil.defaultLogWrite("info", "update Xndroid to " + version);
                            doUpdate();
                        }
                    });
                    builder.setNeutralButton(R.string.ignore, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            LogUtil.defaultLogWrite("info", "ignore version " + version);
