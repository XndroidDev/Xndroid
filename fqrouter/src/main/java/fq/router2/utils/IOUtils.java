...
public class IOUtils {
    ...
    public static File ETC_DIR = new File(MainActivity.sFqHome + "/etc");
    public static File VAR_DIR = new File(MainActivity.sFqHome + "/var");
    public static File LOG_DIR = new File(MainActivity.sFqHome + "/log");
    ...
    public static void writeToFile(File file, String content) {
        try {
            ...
            if(!dir.exists())
                if(!dir.mkdirs())
                    Log.e("fqrouter_xndroid", "mkdirs fail:" + dir.toString());
