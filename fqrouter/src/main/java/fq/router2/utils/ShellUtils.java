...
public class ShellUtils {
    ...
    private final static String[] BINARY_PLACES = {"/data/bin/", "/system/bin/", "/system/xbin/", "/sbin/",
            ...
            "/data/local/"};
    private final static String PYTHON_HOME = MainActivity.sFqHome + "/../python";
    public static File DATA_DIR = new File(MainActivity.sFqHome);
    public static File BUSYBOX_FILE = new File(MainActivity.sFqHome + "/../busybox");
