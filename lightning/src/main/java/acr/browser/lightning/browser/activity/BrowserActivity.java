...
public abstract class BrowserActivity extends ThemableBrowserActivity implements BrowserView, UIController, OnClickListener {
    ...
    private void viewIdFix(){
        ...
        mUiLayout = (ViewGroup) findViewById(R.id.ui_layout);
        mToolbarLayout = (ViewGroup) findViewById(R.id.toolbar_layout);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lightning_main);
